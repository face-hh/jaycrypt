...
const plaintext = rl.question('Enter the text to encrypt: ');
const shift = parseInt(rl.question('Enter the shift value: '));

// Perform encryption
const encryptedText = caesarCipherEncrypt(plaintext, shift);

// Print encrypted text in a stylized format
console.log(chalk.green(`Encrypted Text: ${encryptedText}`));

// Get user input for decryption
const ciphertext = rl.question('Enter the text to decrypt: ');

// Perform decryption
const decryptedText = caesarCipherDecrypt(ciphertext, shift);

// Print decrypted text in a stylized format
console.log(chalk.blue(`Decrypted Text: ${decryptedText}`));